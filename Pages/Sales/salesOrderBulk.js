class salesOrderInputPageBulk {
    constructor(page) {
        ...
        this.selectPackagingType = page.locator("//div/input[@id='radio_field_0_bulk']");

        // this.bagType = page.locator("#bag_type_id_0");
        this.deliveryType = page.locator("#delivery_type_0");
        this.qtyBulk = page.locator("#qty_in_mt_0");
    ...
    async CCDLCreateSalesOrderBulk() {
        ...
        await this.selectAutocomplete(
            this.location,
            "Main Store/Cement Plant Main Store"   //CCDL Pilot server
        ...
        await this.selectAutocomplete(
            this.executive,
            "Md. Zahid Hasan"                         //ccdl Pilot server
            // "Abdullah Al Maruf"
        );
        ...
        await this.selectPackagingType.click();
...
export default salesOrderInputPageBulk;