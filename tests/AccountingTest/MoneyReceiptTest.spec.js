...
async function virtualUser(browser, userNo) {
    ...
    try {
        ...
        for (let i = 0; i < LOOP; i++) {
            ...
            await moneyReceipt.createMoneyReceipt();
    ...
    async () => {
        ...
        try {
            ...
            fs.writeFileSync(
                ...
                "moneyReceiptLoadTestReport.json",
            ...
            console.log(
                "\nReport Saved : moneyReceiptLoadTestReport.json"
            );
